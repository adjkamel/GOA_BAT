...
from common_heva.arguments import parse_args
import torch 
...
from common_heva.camera import *
import collections

from model_heva import *

from common_heva.loss import *
from common_heva.generators import ChunkedGenerator, UnchunkedGenerator, Augmented_Train_ChunkedGenerator
from time import time
from common_heva.utils import *
from matplotlib import pyplot as plt
 
from tqdm.auto import tqdm

from common_heva.data_utils import read_3d_data
from common_heva.graph_utils import adj_mx_from_skeleton_many
...
if args.dataset == 'h36m':
    from common_heva.h36m_dataset import Human36mDataset
    dataset = Human36mDataset(dataset_path)
elif args.dataset.startswith('humaneva'):
    from common_heva.humaneva_dataset import HumanEvaDataset
    dataset = HumanEvaDataset(dataset_path)
elif args.dataset.startswith('custom'):
    from common_heva.custom_dataset import CustomDataset
...
#print('fffffffffffffffff',num_joints)

#########################################PoseTransformer

model_pos_train = GOA_TF(adj=adj, num_frame=receptive_field, num_joints=15, in_chans=2, embed_dim_ratio=32, depth=4,
        num_heads=8, mlp_ratio=2., qkv_bias=True, qk_scale=None,drop_path_rate=0.1)

model_pos = GOA_TF(adj=adj, num_frame=receptive_field, num_joints=15, in_chans=2, embed_dim_ratio=32, depth=4,
...
if not args.evaluate:
    ...
    while epoch < args.epochs:
        ...
        for idx, data_train_epoc in enumerate(tqdm(train_generator.next_epoch(), desc='Train', total=int(train_generator.num_frames()/args.batch_size), ncols=70)):
            ...
            jts=list(range(0,15,1))

            fig,ax=plt.subplots()

            ax.scatter(xx, yy)

            for i, txt in enumerate(jts):
...
if args.render:
    ...
    if args.viz_output is not None:
        ...
        from common_heva.visualization import render_animation
