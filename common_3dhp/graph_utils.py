...
def adj_mx_from_skeleton_many():



    parents=[-1 , 0 , 1  ,2  ,3 , 1  ,5 , 6 , 14 , 8 , 9  ,14 , 11,  12 , 15, 1 ,1]
    

    edges = list(filter(lambda x: x[1] >= 0, zip(list(range(0, 17)), parents)))
    adj_mx =  adj_mx_from_edges(17, edges, sparse=False)
    return adj_mx