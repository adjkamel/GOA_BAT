...
from common_3dhp.graph_utils import adj_mx_from_skeleton_many
...
class GOA_TF(nn.Module):
    def __init__(self, adj,num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4,
        ...
        self.adj= adj_mx_from_skeleton_many()
        ...
        self.conv1D = torch.nn.Conv1d(in_channels=27, out_channels=1, kernel_size=1)
        ...
        _gconv_input = [_GraphConv(self.adj, coords_dim[0], hid_dim, p_dropout=p_dropout)]
    ...
    def forward(self, x):
        ...
        x = torch.unsqueeze(x.permute(0, 3, 1, 2), 4)
