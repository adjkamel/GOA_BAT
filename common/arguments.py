...
def parse_args():
    ...
    parser.add_argument('-lrd', '--lr-decay', default=0.90, type=float, metavar='LR', help='learning rate decay per epoch')
    ...
    parser.add_argument('-frame', '--number-of-frames', default='153', type=int, metavar='N',
