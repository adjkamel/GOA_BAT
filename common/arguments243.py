...
def parse_args():
    ...
    parser.add_argument('-b', '--batch-size', default=8, type=int, metavar='N', help='batch size in terms of predicted frames')
    ...
    parser.add_argument('--downsample', default=10, type=int, metavar='FACTOR', help='downsample frame rate by factor (semi-supervised)')
    ...
    parser.add_argument('--viz-downsample', type=int, default=0.5, metavar='N', help='downsample FPS by a factor N')
