...
def parse_args():
    ...
    parser.add_argument('-a', '--actions', default='Walk,Jog', type=str, metavar='LIST',
    ...
    parser.add_argument('-e', '--epochs', default=500, type=int, metavar='N', help='number of training epochs')
